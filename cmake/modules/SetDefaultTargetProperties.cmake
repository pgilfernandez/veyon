macro(set_default_target_properties TARGET_NAME)
	...
	if(APPLE)
		set_property(TARGET ${TARGET_NAME} PROPERTY INSTALL_RPATH "@executable_path/../lib/veyon")
		set_property(TARGET ${TARGET_NAME} APPEND PROPERTY INSTALL_RPATH "@loader_path/../lib/veyon")
		if(CMAKE_BUILD_RPATH)
			set_property(TARGET ${TARGET_NAME} PROPERTY BUILD_RPATH "${CMAKE_BUILD_RPATH}")
		endif()
	endif()
endmacro()
